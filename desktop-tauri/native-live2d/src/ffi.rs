...
extern "C" {
    ...
    pub fn l2d_model_begin_overlay_settle(m: *mut l2d_model, duration_seconds: c_float);
    pub fn l2d_model_step_overlay_settle(
        m: *mut l2d_model,
        delta_time_seconds: c_float,
    ) -> c_int;
    pub fn l2d_model_reset_all_parameters(m: *mut l2d_model);
