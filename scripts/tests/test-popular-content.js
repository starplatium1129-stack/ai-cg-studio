...
test('blueprints: 48 characters x (6-7 prototype + 4-5 adult), all owned by a character, adult blueprints fail closed for non-adults', function () {
  ...
  assert.deepStrictEqual(adultDist, { 4: 36, 5: 12 }, 'adult distribution must be 36x4 + 12x5');
