...
const repairs = require('./fixtures/scene-coverage-repairs.json');
const characters = popular.parsePopularCharacters(require('../../data/popular-characters.json'));
const blueprints = popular.parseSceneBlueprints(require('../../data/scene-blueprints.json'));
