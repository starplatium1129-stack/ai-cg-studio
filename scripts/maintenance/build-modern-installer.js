...
function verifyUpdaterSignature(executable, signature, publicKey) {
...
if (require.main === module) {
  ...
  const value = (key, fallback) => args.find(arg => arg.startsWith(`--${key}=`))?.slice(key.length + 3) || fallback;
...
module.exports = { buildModernInstaller, verifyUpdaterSignature };
