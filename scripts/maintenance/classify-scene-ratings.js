...
const additions = [
  {
    ...
    char: 'nene', character: ['nene'], lora: 'ayachi_nene_v15', emotion: '害羞而信任', season: '不限', time: '清晨', timeOfDay: 'morning',
    ...
    prompt: '1girl, solo, ayachi_nene, white_hair, low_twintails, purple_eyes, ahoge, hair_ribbon, adult, nude, bath_towel, wet_hair, bare_shoulders, collarbone, standing, bathroom, steam, morning_light, soft_shadows, heavy_blush, close_up, sensual, <lora:ayachi_nene_v15:0.78>',
  ...
  },
  {
    ...
    char: 'natsume', character: ['natsume'], lora: 'shiki_natsume_v15', emotion: '克制的独占欲', season: '不限', time: '深夜', timeOfDay: 'late_night',
    ...
    prompt: '1girl, solo, shiki_natsume, black_hair, long_hair, yellow_eyes, mole_under_eye, adult, nude, bathrobe, bare_shoulders, bare_legs, sitting_on_bed, bedroom, bedside_lamp, looking_at_viewer, slight_blush, night, warm_lighting, medium_shot, sensual, <lora:shiki_natsume_v15:0.78>',
  ...
  },
  {
    ...
    char: 'nene', character: ['nene'], lora: 'ayachi_nene_v15', emotion: '慵懒依恋', season: '不限', time: '破晓', timeOfDay: 'dawn',
    ...
    prompt: '1girl, solo, ayachi_nene, white_hair, low_twintails, purple_eyes, ahoge, hair_ribbon, adult, nude, bedsheet, bare_shoulders, messy_hair, sitting_on_bed, bedroom, dawn, blue_hour, soft_light, heavy_blush, looking_at_viewer, close_up, sensual, <lora:ayachi_nene_v15:0.78>',
  ...
  },
  {
    ...
    char: 'natsume', character: ['natsume'], lora: 'shiki_natsume_v15', emotion: '放松后的温柔', season: '秋', time: '夜晚', timeOfDay: 'night',
    ...
    prompt: '1girl, solo, shiki_natsume, black_hair, long_hair, yellow_eyes, mole_under_eye, adult, nude, outdoor_bath, wet_hair, bare_shoulders, upper_body, steam, moonlight, night, mountain_view, side_view, calm_expression, soft_shadows, medium_shot, sensual, <lora:shiki_natsume_v15:0.78>',
