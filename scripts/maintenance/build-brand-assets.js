...
async function buildBrandAssets() {
  ...
  const svg = (viewBox, body) => `<svg xmlns="http://www.w3.org/2000/svg" viewBox="${viewBox}" role="img" aria-labelledby="title"><title id="title">绘遇 · HUIYU</title>${body}</svg>\n`;
...
module.exports = { buildBrandAssets };
