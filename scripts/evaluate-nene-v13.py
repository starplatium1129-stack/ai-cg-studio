"""Generate a deterministic v11/v13 comparison grid through SD WebUI API."""
...
CANDIDATES = [
    ...
    ("v13-e30", "ayachi_nene_v13_e30_test"),
    ("v13-e45", "ayachi_nene_v13_e45_test"),
]
TESTS = [
    (
        "identity",
        ...
        "ahoge, hair_ribbon, portrait, looking_at_viewer, gentle_smile, soft_lighting, simple_background",
    ),
    (
        "witch",
        "masterpiece, best_quality, very_aesthetic, absurdres, 1girl, solo, "
        "ayachi_nene, white_hair, very_long_hair, low_twintails, purple_eyes, "
        "ahoge, hair_ribbon, full_body, standing, witch_hat, witch_costume, black_cape, "
        "pink_lining, midriff, striped_legwear, handgun, confident_pose, night, moonlight",
    ),
    (
        "control",
        "masterpiece, best_quality, very_aesthetic, absurdres, 1girl, solo, "
        "ayachi_nene, white_hair, very_long_hair, low_twintails, purple_eyes, "
        "ahoge, hair_ribbon, full_body, school_uniform, cardigan, pleated_skirt, "
        "standing, outdoors, autumn_leaves, daylight, looking_at_viewer",
    ),
]
