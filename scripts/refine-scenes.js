...
const additions = [
  {
    ...
    char: 'nene', character: ['nene'], lora: 'ayachi_nene_v14', emotion: '鼓起勇气的信任', season: '秋', time: '闭馆前', timeOfDay: 'evening',
  ...
  },
  {
    ...
    char: 'natsume', character: ['natsume'], lora: 'shiki_natsume_v14', emotion: '沉默的关心', season: '冬', time: '闭店后', timeOfDay: 'night',
