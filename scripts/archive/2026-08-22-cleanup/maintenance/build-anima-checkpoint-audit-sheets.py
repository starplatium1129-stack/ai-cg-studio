"""Build labelled E10/E20/E45 contact sheets for the Anima checkpoint audit."""
...
def main() -> None:
    ...
    scenes = candidate_manifest["scenes"]
    ...
    for scene_id in scenes:
        ...
        for row, seed in enumerate(seeds):
            paths = (
                ("E10", candidates[(scene_id, seed, "e10")]),
                ("E20", candidates[(scene_id, seed, "e20")]),
                ("E45", final_records[(scene_id, seed)]),
            )
        ...
        target = output / f"{scene_id}-e10-e20-e45.jpg"
