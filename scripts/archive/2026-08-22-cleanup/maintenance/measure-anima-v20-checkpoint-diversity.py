"""Measure seed diversity for V20 E08/E12 and the production V19 baseline."""
...
def main() -> None:
    ...
    for scene_id in candidate_manifest["scenes"]:
        result["scenes"][scene_id] = {
            "e08": metrics([candidates[(scene_id, seed, "e08")] for seed in seeds]),
            "e12": metrics([candidates[(scene_id, seed, "e12")] for seed in seeds]),
            "v19": metrics([production[(scene_id, seed)] for seed in seeds]),
        }
