...
| P2 | 视频基础创作链路已实现；素材串用、重复提交与草稿恢复已修复，见[9-10 审计](archive/audits/video-gallery-recovery-2026-09-10.md)；真实成片与剧本丰富度仍待深化 | 真机复验首尾帧与重复生成，再小批补剧本；超分、Wan 增强独立测显存与耗时 | 首帧、镜头、对白、成片可追踪，失败可恢复；新模型有固定 seed 实测 |
