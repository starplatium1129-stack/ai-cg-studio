...
> 历史研究，保留当时结论与出处。2026-09-13 补充的 [叙事 CG 研究](anima-krea2-narrative-cg-research-2026-09-12.md) 已核对固定长度、格式能力、CFG 和托管／本地混用等冲突；当前执行以 [studio-prompt-craft](../../../.agents/skills/studio-prompt-craft/SKILL.md) 为准，不直接将下文旧断言批量应用到数据。
...
> 与 2026-08-14 指南的历史关系和修正清单见 §11；当前规范及后续研究入口见上方说明。
