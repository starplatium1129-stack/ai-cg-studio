...
> 历史设计方案（2026-09-12 整理）：当前已有双窗口路由与原生窗口实现；下文的旧单窗口现状、行数和“零丢失”表述不作当前能力保证。当前代码复现与未完成项见 [独立审计](../../archive/audits/office-independent-audit-2026-09-12.md) 和 [未来规划](../../roadmap.md)，不按旧方案重复迁移。
