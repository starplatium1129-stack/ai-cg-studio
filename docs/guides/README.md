...
按问题查阅；通用约束以 DESIGN 与工程契约为准。专题中的历史实验、参数和验证日期不代表当前生产状态。
...
- [AI-CG-Studio 视觉资产终身审核标准与认知对齐宪章 (v1.5.0)](characters/quality-audit-standards-charter.md)
- [场景维护工作台重构 · 1.5.7](characters/scene-maintenance-workspace.md)
...
- [词条出图语义参考（Tag → Visual Semantics）](prompts/tag-visual-semantics.md)
- [三引擎提示词调研与精细化配置基线（Krea 2 / Anima / SD-Illustrious）](prompts/three-engine-prompt-research.md)

<a id="video"></a>

## 视频

- [剧情短片工作流调研与本项目应用方案](video/narrative-short-film-workflow.md)
- [分镜短片「AI 整理」链路（2026-08-16）](video/video-ai-storyboard.md)
