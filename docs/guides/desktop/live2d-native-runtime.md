...
> 更新：2026-09-12；下文历史原生验收记录保留各自适用范围。
...
- `src/types/live2dNative.ts` 与 `docs/research/desktop/live2d-native-overlay-plan.md` 是 IPC 公共契约；新增命令沿用 typed command/reply，不暴露任意路径、参数或执行能力。
