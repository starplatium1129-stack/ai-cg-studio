...
- 自动提取场景台词或朗读完整故事，支持系统声音试听与本机 GPT-SoVITS 角色声线
...
双击 `control.bat`，确认 WebUI 地址后点击 **启动并生成分享链接**。当前电脑已配置宁宁、夏目的本地 GPT-SoVITS 声线，控制面板会自动检查并启动语音服务；没有语音服务时，导演台的系统声音试听仍可使用。
