...
for(const [id,[before,after]]of Object.entries(surtr)) edit('data/blueprints/arknights.json',d=>d.blueprints.find(b=>b.id===id),{promptProse:before},{promptProse:after});
